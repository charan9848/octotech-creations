            ...
            <Box sx={{ display: "flex", flexDirection: { xs: "column-reverse", sm: "row" }, justifyContent: "space-between", alignItems: "center" }}> 
                <Box>
                    <motion.div
                        ...
                        <Box 
                            component="img"
                            src="https://placehold.co/600x400/1a1a1a/white?text=Motion+Graphics+Preview"
                ...
                <Box py={{md:5, xs:2, sm:3, lg:5}} pl={{md:4}} textAlign={{xs:'center',md:'start', sm:'start'}}>
                    ...
                    viewport={{ once: true, amount: 0.7 }}>
                        <Box m={1} sx={{ display: 'flex', justifyContent: {xs: 'center', md: 'flex-start'} }}>
                            <TimelineOutlinedIcon sx={{ fontSize: 50, color: '#00B2FF' }} />
                        </Box>
                        <Box m={1} >
                            <Typography variant="h4" color="white">MOTION GRAPHICS</Typography>
                        </Box>
                    </motion.div>
                    <motion.div
                     variants={fadeIn('left', 0.4)}
                        ...
                        <Box m={1} mb={3}>
                            <Typography variant="h6" sx={{ lineHeight: 1.8, color: '#aeb4b4', fontSize: '16px' }}>
                                Animated graphics, infographics, and visual elements that enhance your content with professional motion design.
                            </Typography>
                        </Box>
                    </motion.div>
                </Box>
