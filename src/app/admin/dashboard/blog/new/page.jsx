...
import { Box, Typography, Paper, TextField, Button, CircularProgress, IconButton, Chip, FormControl, InputLabel, Select, MenuItem, LinearProgress } from '@mui/material';
      ...
      <Box sx={{ display: 'flex', gap: 3, flexDirection: { xs: 'column', lg: 'row' } }}>
        ...
        <Paper sx={{ flex: 2, p: 3, bgcolor: '#13171a', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
          ...
          <TextField
            ...
            helperText="Short summary for previews. Auto-generated if left empty."
            FormHelperTextProps={{ sx: { color: '#666' } }}
          />
